...
public class ItemVendorMenu extends Menu {
    ...
    public ItemVendorMenu(String npcName, int slots) {
        ...
        setItem(1, ItemGenerator.generateEnchant(1, Tier.T5, "Armor").setPrice(1000).build());
        ...
        setItem(6, ItemGenerator.generateEnchant(1, Tier.T5, "Weapon").setPrice(1000).build());
