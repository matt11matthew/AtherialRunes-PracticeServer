 ...
 */
public class CommandToggleChaos extends AtherialCommand {

    public CommandToggleChaos(String command, List<String> aliases) {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            PlayerToggles toggle = PlayerToggles.CHAOTIC_PREVENTION;
